...
if (rootdir) {
  ...
  if (fs.existsSync(plist)) {
    exec('/usr/libexec/PlistBuddy -c "Set :CFBundleVersion ' + configobj.build + '" platforms/ios/OpenNMS/OpenNMS-Info.plist', puts);
  }
